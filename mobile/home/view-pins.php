        ...
        <div class="card card-style">
            <div class="content">
                ...
                <div>
                    ...
                    <?php $network=$data->network; $datasize=$data->datasize; $loadpin="**460*6*1# Then PIN or Text PIN to 460"; if($datasize=="1.5GB"){$loadpin="*460*6*1# Then PIN or Text PIN to 460"; $checkBal="*460*260#";} ?>
                    <?php if($network == "AIRTEL"){$cardColor="#ff1a1a"; $cardLogo="airtel.png"; $textColor="#ffffff"; $checkBal="*140#";} 
                    else {$cardColor="#ffcc00"; $cardLogo="mtn.png"; $textColor="#000000"; $checkBal="*460*260#";} ?>
