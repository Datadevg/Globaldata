<div class="page-content header-clear-medium">
        ...
        <div class="card card-style">
            <div class="content">
                <p class="mb-0 font-600 color-highlight">VTU TELECOM</p>
                <h1>About Us</h1>
                <p class="text-black">
                VTU TELECOM is your onestop platform for all your bills payment. We provide you an easy way to topup your Airtime, Internet Data, Cable TV Subscription, and Electricity Subscription.                
