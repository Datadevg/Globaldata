<?php
	...
	class Model{
		...
		public static $dbName="vtuetopo_Datatada"; //Database Name
		public static $username="vtuetopo_Datatada"; // Database Username
		public static $password="vtuetopo_Datatada"; //Database Password
 
        public $dbh;
        
		public $emailUsername="support@dev.com"; //Support Email Address
		public $emailPassword="vtuetopo_Datatada"; //Support Email Password
