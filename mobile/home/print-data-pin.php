        ...
        <div class="">
            <div class="content">
                <div class="row">
                    ...
                    <?php $network=$data->network; $datasize=$data->datasize; $loadpin="*460*6*1# Then PIN"; if($datasize=="1.5GB"){$loadpin="*460*6*1# Then pin"; $checkBal="*460*260# ";} ?>
                    <?php if($network == "AIRTEL"){$cardColor="#ff1a1a"; $cardLogo="airtel.png"; $textColor="#ffffff"; $checkBal="*140#";} 
                    else {$cardColor="#ffcc00"; $cardLogo="mtn.png"; $textColor="#000000"; $checkBal="*461*4# or *460*260#";} ?>
